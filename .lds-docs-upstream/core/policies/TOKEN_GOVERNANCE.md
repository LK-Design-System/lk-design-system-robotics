...
live in [`EXPRESSION_PROFILE_CONTRACT.json`](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.2.3/docs/references/architecture/EXPRESSION_PROFILE_CONTRACT.json),
