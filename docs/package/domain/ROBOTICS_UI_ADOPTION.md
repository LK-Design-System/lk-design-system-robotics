...
This document adds Robotics-specific decisions to the shared LDS UI adoption contract. The shared six-facet contract and report schema are projected into [`package/`](../) from a hash-pinned upstream LDS source; they are not re-authored here.
